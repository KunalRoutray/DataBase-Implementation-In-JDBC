 ...
 */
    ...
    public static void main(String[] args) {
        ...
        page.insertRecord("Computer Science".getBytes());
        ...
        page.insertRecord("Economics".getBytes());
        page.insertRecord("History".getBytes());
        page.insertRecord("Geography".getBytes());
        page.insertRecord("Statistics".getBytes());
